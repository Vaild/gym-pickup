...
def getKeyBytes(key):
  ...
  if remainder > 0:
    keyBytes.append(strToBt(key[iterator * 4 + 0: iterator * 4 + 4]))
  return keyBytes
...
def generateKeys(keyByte):
  ...
  for i in range(16):
    ...
    if i == 0:
      for m in range(48):
        keys[0].append(tempKey[m])
    elif i == 1:
      for m in range(48):
        keys[1].append(tempKey[m])
    elif i == 2:
      for m in range(48):
        keys[2].append(tempKey[m])
    elif i == 3:
      for m in range(48):
        keys[3].append(tempKey[m])
    elif i == 4:
      for m in range(48):
        keys[4].append(tempKey[m])
    elif i == 5:
      for m in range(48):
        keys[5].append(tempKey[m])
    elif i == 6:
      for m in range(48):
        keys[6].append(tempKey[m])
    elif i == 7:
      for m in range(48):
        keys[7].append(tempKey[m])
    elif i == 8:
      for m in range(48):
        keys[8].append(tempKey[m])
    elif i == 9:
      for m in range(48):
        keys[9].append(tempKey[m])
    elif i == 10:
      for m in range(48):
        keys[10].append(tempKey[m])
    elif i == 11:
      for m in range(48):
        keys[11].append(tempKey[m])
    elif i == 12:
      for m in range(48):
        keys[12].append(tempKey[m])
    elif i == 13:
      for m in range(48):
        keys[13].append(tempKey[m])
    elif i == 14:
      for m in range(48):
        keys[14].append(tempKey[m])
    elif i == 15:
      for m in range(48):
        keys[15].append(tempKey[m])
  return keys
      ...
      if (leng < 4):
        ...
        if (firstKey != None and firstKey != "" and secondKey != None and secondKey != "" and thirdKey != None and thirdKey != ""):
          ...
          for x in range(firstLength):
            tmpBt = enc(tmpBt, firstKeyBt[x])
          for y in range(secondLength):
            tmpBt = enc(tmpBt, secondKeyBt[y])
          for z in range(thirdLength):
            tmpBt = enc(tmpBt, thirdKeyBt[z])
          encByte = tmpBt
        else:
...
def strDec(data, firstKey, secondKey, thirdKey):
  leng = len(data)
  decStr = ""
  firstKeyBt,secondKeyBt,thirdKeyBt,firstLength,secondLength,thirdLength = None,None,None,None,None,None
  if (firstKey != None and firstKey != ""):
    firstKeyBt = getKeyBytes(firstKey)
    firstLength = len(firstKeyBt)
  if (secondKey != None and secondKey != ""):
  ...
  for i in range(iterator):
    ...
    if (firstKey != None and firstKey != "" and secondKey != None and secondKey != "" and thirdKey != None and thirdKey != ""):
      ...
      for z in range(firstLength - 1, -1, -1):
        tempBt = dec(tempBt, thirdKeyBt[z])
      decByte = tempBt
    else:
      if (firstKey != None and firstKey != "" and secondKey != None and secondKey != ""):
        tempBt = intByte
